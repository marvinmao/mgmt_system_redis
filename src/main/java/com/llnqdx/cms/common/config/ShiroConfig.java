package com.llnqdx.cms.common.config;
...
import com.llnqdx.cms.common.security.shiro.session.CacheSessionDAO;
import com.llnqdx.cms.common.security.shiro.session.SessionManager;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(CacheSessionDAO dao) {
        ...
        sessionManager.setSessionIdCookie(new SimpleCookie("llnqdx.cms.session.id"));
