package com.llnqdx.cms.common.servlet;
...
import com.llnqdx.cms.common.utils.FileUtils;
...
@WebServlet(urlPatterns = "/static/ckfinder/core/connector/java/connector.java", initParams = {
        ...
        @WebInitParam(name = "configuration", value = "com.llnqdx.cms.common.web.CKFinderConfig")
}, loadOnStartup = 1)
